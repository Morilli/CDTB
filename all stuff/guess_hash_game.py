...
game_guess.check_basenames(f"yuumi_skin07_joke_tx_cm.dds" for a in "ab")
...
# game_guess.grep_wad(Wad(r"G:\Dokumente\Utility Tools\LeagueDownloader_1_0_2_0\game_old\lol_game_client\releases\0.0.1.101\files\DATA\FINAL\Scripts.wad.client"))
